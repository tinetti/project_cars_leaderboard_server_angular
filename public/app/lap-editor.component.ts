...
<form class="save-lap navbar-form navbar-left">
    <div class="row">
        ...
        <input type="hidden" name="createdTimestamp" value=""/>
        <input type="hidden" name="modifiedTimestamp" value=""/>
        <input class="col-xs-1" type="text" name="driver" placeholder="Driver" [(ngModel)]="lap.driver"/>
        ...
        <input class="col-xs-1" type="text" name="carName" placeholder="Car Name" [(ngModel)]="lap.carName"/>
        <input class="col-xs-2" type="text" name="carClassName" placeholder="Car Class" [(ngModel)]="lap.carClassName"/>
        <input class="col-xs-2" type="text" name="lapTimestamp" placeholder="Date" [(ngModel)]="lap.lapTimestamp"/>
    </div>
    <div class="row">
